            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <SidebarNavItem glyph='icon-fontello-table' name='Tables' href='/tables' />

                  { /** Documentation Section */ }
                  <div className='sidebar-header'>TRADE MONITORING</div>
                  <li className='sidebar-nav-item' style={{display: 'block', height: 45}}>
                    <a href='https://github.com/ShaneK/Matador' target='_blank' style={{height: 45}}>
                      <Icon glyph='icon-fontello-gauge' />
                      <span className='name'>Queue Dashboard</span>
                    </a>
                  </li>
                </SidebarNav>
              </div>
